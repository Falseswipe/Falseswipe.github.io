...
Scene.prototype.parseOptions = function parseOptions(startIndent, choicesRemaining, expectedSubOptions) {
    ...
    while(isDefined(line = this.lines[++this.lineNum])) {
        ...
        if (nextIndent === null || nextIndent === undefined) {
            ...
            if (indent <= startindent)="" {="" throw="" new="" error(this.linemsg()="" +="" "invalid="" indent,="" expected="" at="" least="" one="" '"="" currentchoice="" "'");="" }="" this.indent="nextIndent" =="" indent;="" if="" (indent="" <="startIndent)" it's="" over!="" todo="" is="" this="" error="" test="" valid?="" (choicesremaining.length="">1 && !suboptionsEncountered) {
...
Scene.prototype.parseRestoreGame = function parseRestoreGame(alreadyFinished) {
    ...
    while(isDefined(line = this.lines[++this.lineNum])) {
        ...
        if (indent <= startindent)="" {="" it's="" over!="" if="" (!alreadyfinished)="" this.linenum--;="" this.rollbacklinecoverage();="" }="" return="" unrestorablescenes;="" (indent="" !="this.indent)" all="" chart="" rows="" are="" supposed="" to="" be="" at="" the="" same="" indentation="" level="" anything="" wrong="" might="" a="" mis-indented="" title="" definition="" or="" just="" typo="" throw="" new="" error(this.linemsg()="" +="" "invalid="" indent,="" expected="" "+this.indent+",="" was="" "="" indent);="" *restore_game="" ending="" you="" can't="" restore="" ending.="" line="trim(line);" var="" result="/^(\w+)\s+(.*)/.exec(line);" (!result)="" line;="" this="" should="" have="" scene="" name="" followed="" by="" an="" error="" message:="" line);="" scenename="result[1].toLowerCase();" unrestorablescenes[scenename]="error;" };="" scene.prototype.check_registration="function" scene_checkregistration()="" (typeof="" window="=" "undefined"="" ||="" typeof="" isregistered="=" "undefined")="" return;="" this.finished="true;" this.skipfooter="true;" self="this;" isregistered(function()="" self.finished="false;" self.skipfooter="false;" self.execute();="" });="" scene.prototype.login="function" scene_login(optional)="" loginform="=" optional="trim(optional);" (optional)="" (optional="" )="" *login="" option:="" optional);="" this.paragraph();="" target="this.target;" (!target)="" loginform(target,="" optional,="" null,="" function()="" clearscreen(function()="" self.prevline="empty" ;="" self.screenempty="true;" scene.prototype.save_game="function" save_game(destinationscenename)="" (!destinationscenename)="" error(this.linemsg()+"*save_game="" requires="" destination="" file="" name,="" e.g.="" *save_game="" episode2");="" (this.temps.choice_user_restored)="" fetchemail(function(defaultemail){="" self.paragraph();="" form="document.createElement(" form");"="" setclass(form,="" "savegame");="" form.action="#" message="document.createElement(" div");"="" message.style.color="red" message.style.fontweight="bold" form.appendchild(message);="" savename="document.createElement(" input");"="" savename.type="text" savename.name="saveName" savename.setattribute("placeholder",="" "type="" for="" your="" saved="" game");="" savename.setattribute("style",="" "display:block;="" font-size:="" 25px;="" width:="" 90%;="" margin:="" 1rem="" 0");="" form.appendchild(savename);="" hideemailform="false;" (!hideemailform)="" println("please="" login="" choiceofgames.com="" save="" system="" with="" email="" address="" below.",="" form);="" emailinput="document.createElement(" can="" fail="" on="" ie="" try="" emailinput.type="email" catch="" (e)="" {}="" emailinput.name="email" emailinput.value="defaultEmail;" emailinput.setattribute("placeholder",="" "you@example.com");="" emailinput.setattribute("style",="" form.appendchild(emailinput);="" subscribelabel="document.createElement(" label");"="" subscribelabel.setattribute("for",="" "subscribebox");="" subscribebox="document.createElement(" subscribebox.type="checkbox" subscribebox.name="subscribe" subscribebox.setattribute("id",="" subscribebox.setattribute("checked",="" true);="" subscribelabel.appendchild(subscribebox);="" subscribelabel.appendchild(document.createtextnode("email="" me="" when="" games="" available."));="" form.appendchild(subscribelabel);="" target.appendchild(form);="" printbutton("next",="" form,="" printbutton("cancel",="" target,="" false,="" form.onsubmit="function(e)" preventdefault(e);="" safecall(this,="" messagetext;="" (!trim(savename.value))="" messagetext="document.createTextNode(" please"="" type="" game.");="" message.innerhtml="" message.appendchild(messagetext);="" slot="save" date().gettime();="" create="" clone="" stats="" object="" whose="" is="" savestats="{};" (var="" stat="" in="" self.stats)="" ("scene"="=" stat)="" continue;="" savestats[stat]="self.stats[stat];" savestats.scene="{name:destinationSceneName};" (hideemailform)="" savecookie(function()="" recordsave(slot,="" },="" slot,="" savestats,="" {choice_reuse:"allow",="" choice_user_restored:true,="" choice_restore_name:savename.value},="" 0,="" self.nav);="" shouldsubscribe="subscribeBox.checked;" (!="" ^\s+@\s+\.\s+$="" .test(email))="" \""+email+"\"="" not="" address.="" please="" again.");="" recordemail(email,="" startloading();="" submitremotesave(slot,="" email,="" shouldsubscribe,="" function(ok)="" doneloading();="" (!ok)="" asyncalert("couldn't="" upload="" game="" choiceofgames.com.="" again="" later="" from="" menu.",="" else="" printfooter();="" scene.prototype.show_password="function" show_password()="" (typeof(window)="" &&="" !window.ismobile)="" this.printline('please="" copy="" and="" paste="" password="" safe="" place,="" then="" press="" "next"="" below="" continue.');="" println("",="" this.target);="" this.temps,="" this.linenum,="" this.indent);="" showpassword(this.target,="" password);="" this.prevline="block" scene.prototype.obfuscate="function" obfuscate(password)="" password.replace(="" .="" g,="" function(x)="" y="self.obfuscator[x];" y;="" );="" obfuscator="" must="" take="" us-ascii="" obfuscate="" it="" use="" password.="" will="" sent="" via="" html="" its="" whitespace="" handling="" unpredictable,="" so="" we="" output="" any="" of="" these="" characters:="" [="" <="">&]
...
Scene.prototype.parseStatChart = function parseStatChart() {
    ...
    while(isDefined(line = this.lines[++this.lineNum])) {
        ...
        if (nextIndent === null || nextIndent === undefined) {
            // initialize nextIndent with whatever indentation the line turns out to be
            // ...unless it's not indented at all
            if (indent <= startindent)="" {="" throw="" new="" error(this.linemsg()="" +="" "invalid="" indent,="" expected="" at="" least="" one="" row");="" }="" this.indent="nextIndent" =="" indent;="" if="" (indent="" <="startIndent)" it's="" over!="" this.rollbacklinecoverage();="" this.linenum="this.previousNonBlankLineNum();" return="" rows;="" !="this.indent)" all="" chart="" rows="" are="" supposed="" to="" be="" the="" same="" indentation="" level="" anything="" wrong="" might="" a="" mis-indented="" title="" definition="" or="" just="" typo="" "+this.indent+",="" was="" "="" indent);="" *stat_chart="" text="" wounds="" percent="" infamy="" opposed_pair="" brutality="" strength="" and="" cruelty="" finesse="" precision="" aerial="" maneuverability="" todo="" definitions="" variable="" substitutions="" *if="" *else="" *line_break="" line="trim(line);" var="" result="/^(text|percent|opposed_pair)\s+(.*)/.exec(line);" (!result)="" line;="" this="" should="" start="" with="" 'percent',="" 'text',="" 'opposed_pair'");="" type="result[1].toLowerCase();" data="trim(result[2]);" ("opposed_pair"="=" type)="" this.getvar(data);="" line1="this.lines[++this.lineNum];" this.replacevariables(line1);="" line1indent="this.getIndent(line1);" (line1indent="" indented="" indicate="" opposed="" pair="" name.="" indent:="" ",="" greater="" than="" this.indent);="" line2="this.lines[this.lineNum" 1];="" line2indent="this.getIndent(line2);" (line2indent="" only="" rows.push({type:="" type,="" variable:="" data,="" label:="" opposed_label:="" trim(line1)});="" else="" this.linenum++;="" this.replacevariables(line2);="" line1indent)="" two="" lines:="" first="" label,="" second="" label="" trim(line1),="" trim(line2)});=""> line1indent) {
          ...
          if (line2indent <= 1="" 2="2" 1200="" 2016="" this.indent)="" {="" no="" definition="" line="" rows.push({type:="" type,="" variable:="" variable,="" label:="" label});="" }="" else="" this.linenum++;="" this.replacevariables(line2);="" label,="" definition:="" trim(line2)});="" return="" rows;="" };="" *timer="" dec="" 25,="" 9:30:00="" pdt="" scene.prototype.timer="function(dateString)" var="" end;="" if="" (datestring="=" "release")="" (typeof="" window="==" "undefined"="" ||="" !window.releasedate)="" return;="" end="window.releaseDate/1000;" now="new" date()="" 1000;="" (now="" <="" end)="" target="this.target;" (!target)="" document.getelementbyid('text').appendchild(target);="" self="this;" showticker(target,="" end,="" function()="" clearscreen(loadandrestoregame());="" });="" *delay_break="" scene.prototype.delay_break="function(durationInSeconds)" (isnan(durationinseconds="" *="" 1))="" throw="" new="" error(this.linemsg()="" +="" "invalid="" duration");="" this.finished="true;" this.skipfooter="true;" this.paragraph();="" delaybreakstart(function(delaystart)="" window.blockrestart="true;" endtimeinseconds="durationInSeconds" delaystart="" 1;="" endtimeinseconds,="" printbutton("next",="" target,="" false,="" delaybreakend();="" self.finished="false;" self.resetpage();="" printfooter();="" *delay_ending="" $2.99="" $0.99="" scene.prototype.delay_ending="function(data)" steam="" doesn't="" do="" delay="" breaks="" and="" especially="" not="" skiponce="" !="undefined" &&="" !!window.issteamapp)="" this.ending();="" args="data.split(/" );="" durationinseconds="args[0];" fullpriceguess="args[1];" singleusepriceguess="args[2];" (!="" ^\$="" .test(fullpriceguess))="" fullpriceguess:="" \""+fullpriceguess+"\"");="" (singleusepriceguess="" .test(singleusepriceguess))="" singleusepriceguess:="" \""+singleusepriceguess+"\"");="" checkpurchase("adfree",="" function(ok,="" result)="" (result.adfree="" !result.billingsupported)="" self.ending();="" getprice("adfree",="" function="" (fullprice)="" (fullprice="=" "guess")="" fullprice="fullPriceGuess;" getprice("skiponce",="" (singleuseprice)="" (singleuseprice="=" singleuseprice="singleUsePriceGuess;" options="[];" finishedwaiting="{name:" "play="" again="" after="" a="" short="" wait.="" ",="" unselectable:="" true};="" options.push(finishedwaiting);="" upgradeskip="{name:" "upgrade="" to="" the="" unlimited="" version="" for="" "="" skip="" wait="" forever."};="" options.push(upgradeskip);="" "skip="" one="" time="" "."};="" (singleusepriceguess)="" options.push(skiponce);="" restorepurchasesoption="{name:" "restore="" purchases="" from="" another="" device."};="" (isrestorepurchasessupported())="" options.push(restorepurchasesoption);="" playmoregames="{name:" more="" games="" like="" this."};="" options.push(playmoregames);="" emailme="{name:" "email="" me="" when="" are="" available."};="" options.push(emailme);="" self.paragraph();="" printoptions([""],="" options,="" function(option)="" (option="=" playmoregames)="" self.more_games("now");="" curl="" )="" curl();="" emailme)="" subscribelink();="" upgradeskip)="" purchase("adfree",="" safecall(self,="" self.restart();="" skiponce)="" purchase("skiponce",="" restorepurchasesoption)="" restorepurchases("adfree",="" clearscreen(loadandrestoregame);="" clearscreen(function()="" *if="" booleanexpr="" execute="" different="" code="" depending="" on="" whether="" is="" true="" or="" false="" examples:="" bool-expression="" blah="" *elseif="" *else="" by="" reference="" *set="" foo="" ...="" equality="" inequality="">2
//         foo<2 foo<="2" foo="">=2
//     and/or logic, parentheses mandatory
//         (foo=2) or (foo=3)
//         ((foo>4) and (foo<8)) or="" (bar="0)" note:="" *if="" commands="" may="" be="" used="" inside="" *choices,="" to="" make="" some="" choices="" conditionally="" available="" scene.prototype["if"]="function" scene_if(line)="" {="" var="" stack="this.tokenizeExpr(line);" result="this.evaluateExpr(stack);" if="" (this.debugmode)="" println(line="" +="" "="" ::="" result);="" this.linenum+1);="" (result)="" "true"="" branch,="" just="" go="" on="" the="" next="" line="" this.indent="this.getIndent(this.nextNonBlankLine());" }="" else="" "false"="" branch;="" skip="" over="" true="" branch="" this.skiptruebranch(false);="" };="" todo="" rename="" this="" function="" skipbranch="" scene.prototype.skiptruebranch="function" skiptruebranch(inelse)="" startindent="this.indent;" nextindent="null;" while="" (isdefined(line="this.lines[++this.lineNum]))" this.rollbacklinecoverage();="" (!trim(line))="" continue;="" indent="this.getIndent(line);" (nextindent="==" null="" ||="" undefined)="" (indent="" <="startIndent)" throw="" new="" error(this.linemsg()="" "invalid="" indent,="" expected="" at="" least="" one="" in="" 'if'="" block");="" block="" is="" parsed;="" check="" see="" an="" *else="" *elseif="" startindent)="" parsed="/^\s*\*(\w+)(.*)/.exec(line);" (!parsed="" inelse)="" this.linenum="this.previousNonBlankLineNum();" return;="" command="parsed[1].toLowerCase();" data="trim(parsed[2]);" ("else"="=" command)="" (data)="" (="" ^if\b="" .test(data))="" "'else="" if'="" invalid,="" use="" 'elseif'");="" "nothing="" should="" appear="" a="" after="" 'else':="" data);="" code="" coverage="" ^else?if$="" .test(command))="" this["if"](data);="" nextindent)="" foo="" bar="" "+nextindent+",="" was="" indent);="" scene.prototype["else"]="Scene.prototype.elsif" =="" scene.prototype.elseif="function" scene_else(data,="" inchoice)="" authors="" can="" avoid="" using="" goto="" get="" out="" of="" with:="" *set="" implicit_control_flow="" avoids="" error="" message="" end="" function.="" (inchoice="" this.stats["implicit_control_flow"])="" this.skiptruebranch(true);="" "it="" illegal="" fall="" statement;="" you="" must="" *goto="" *finish="" before="" indented="" block.");="" break="" string="" up="" into="" tokens,="" defined="" scene.tokens="" below="" scene.prototype.tokenizeexpr="function" tokenizeexpr(str)="" tokentypes="Scene.tokens;" tokentypeslength="tokenTypes.length;" pos="0;" (str)="" matched="false;" for="" (var="" i="0;" tokentypeslength;="" i++)="" tokentype="tokenTypes[i];" token="tokenType.test(str," (token)="" str="str.substr(token.length);" item="{name:tokenType.name," value:token,="" pos:pos};="" ("whitespace"="=" tokentype.name)="" break;="" ("curly_quote"="=" error(this.linemsg()+"invalid="" curly="" smart="" quote:="" "\nuse="" straight="" quotes="" \"="" instead")="" ("function"="=" item.func="/^\w+/.exec(token)[0];" stack.push(item);="" (!matched)="" expression,="" couldn't="" extract="" another="" token:="" str);="" return="" stack;="" evaluate="" tokens="" parenthetical="=" we're="" evaluating="" expression="" all="" expressions="" consist="" either="" "singleton"="" value="" (2)="" two="" values="" and="" operator="" (2+2)="" scene.prototype.evaluateexpr="function" evaluateexpr(stack,="" parenthetical)="" (!stack.length)="" "no="" specified");="" self="this;" gettoken()="" (!token)="" error(self.linemsg()="" "null="" token");="" token;="" token,="" value1,="" value2,="" operator,="" result;="" value1="this.evaluateValueToken(getToken()," stack);="" (parenthetical)="" parenthetical);="" value1;="" (parenthetical="" &&="" token.name)="" since="" isn't="" singleton,="" it="" (!operator)="" char="" "+token.pos+",="" operator"+="" (parenthetical?"="" :="" "")+="" ",="" was:="" token.name="" ["="" token.value="" "]");="" (token.value="==" '%')="" this.warning("this="" bare="" %="" sign,="" which="" replaced="" with="" %+,="" %-,="" modulo="" you're="" really="" advanced.");="" this.warning("for="" more="" details="" modulo,="" see:="" https:="" forum.choiceofgames.com="" t="" 21176");="" (!stack[0])="" something="" "+token.value);="" (stack[0].func="=" "auto")="" value2="this.autobalance(stack," value1);="" do="" this.linenum+1,="" this);="" expect="" close="" parenthesis="" (stack.length)="" "+parenthetical+",="" not="" parenthetical,="" no="" found:="" "bug,="" how="" did="" here?");="" turn="" number,="" string,="" its="" or,="" open parenthesis,="" scene.prototype.evaluatevaluetoken="function" evaluatevaluetoken(token,="" stack)="" name="token.name;" value;="" ("open_parenthesis"="=" name)="" this.evaluateexpr(stack,="" "close_parenthesis");="" ("open_curly"="=" "close_curly");="" this.getvar(value);="" (!this.functions[token.func])="" error(this.linemsg="" "unknown="" token.func);="" this.functions[token.func].call(this,="" value);="" ("number"="=" token.value;="" ("string"="=" strip="" off="" unescape="" backslashes="" this.replacevariables(token.value.slice(1,-1).replace(="" \\(.)="" g,="" "$1"));="" ("var"="=" variable="String(token.value);" (stack.length="" stack[0].name="=" "open_square")="" stack.shift();="" "close_square");="" this.getvar(variable);="" name,="" remove="" from="" it's="" that="" array="" convert="" raw="" underscore="" scene.prototype.evaluatereference="function" evaluatereference(stack,="" options)="" tolowercase="true;" (options="" options.hasownproperty("tolowercase"))="" findclosingbracket(stack,="" type,="" offset)="" (!offset)="" offset="0;" opens="0;" opentype="OPEN_" +type;="" closetype="CLOSE_" stack.length;="" (stack[i].name="=" opentype)="" opens++;="" closetype)="" (opens)="" opens--;="" i;="" -1;="" normalizecase(name)="" (tolowercase)="" string(name).tolowercase();="" name;="" name");="" (stack[0].name="==" "open_curly")="" closingcurly="findClosingBracket(stack," "curly");="" (closingcurly="=" -1)="" closing="" bracket:="" closingcurly));="" stack.splice(0,="" closingcurly+1);="" normalizecase(name);="" "number")="" could="" have="" label="" that's="" number="" !="=" "var")="" expression;="" found="" stack[0].pos);="" while(stack.length="" closingbracket="findClosingBracket(stack," "square",="" 1);="" (closingbracket="=" bracket="" stack[1].pos);="" index="this.evaluateExpr(stack.slice(1," closingbracket));="" index;="" closingbracket+1);="" scene.prototype.functions="{" not:="" function(value)="" !bool(value,="" },="" round:="" (isnan(value*1))="" error(this.linemsg()+"round()="" number:="" math.round(value);="" timestamp:="" date.parse(value)="" 1000;="" log:="" error(this.linemsg()+"log()="" math.log(value)="" math.log(10);="" length:="" string(value).length;="" auto:="" function()="" auto()="" come=""> symbol");
  }
};
...
Scene.prototype.parseGotoRandomScene = function parseGotoRandomScene(data) {
    ...
    while(isDefined(line = this.lines[++this.lineNum])) {
        ...
        if (nextIndent === null || nextIndent === undefined) {
            // initialize nextIndent with whatever indentation the line turns out to be
            // ...unless it's not indented at all
            if (indent <= 100="" startindent)="" {="" throw="" new="" error(this.linemsg()="" +="" "invalid="" indent,="" expected="" at="" least="" one="" line="" in="" *goto_random_scene");="" }="" this.indent="nextIndent" =="" indent;="" if="" (indent="" <="startIndent)" it's="" over!="" this.rollbacklinecoverage();="" this.linenum--;="" break;="" !="this.indent)" all="" chart="" rows="" are="" supposed="" to="" be="" the="" same="" indentation="" level="" anything="" wrong="" might="" a="" mis-indented="" title="" definition="" or="" just="" typo="" "+this.indent+",="" was="" "="" indent);="" var="" option="{allowReuse:allowReuseGlobally};" command;="" while(!!(command="/^\*(\S+)/.exec(line)))" command="command[1];" ("allow_reuse"="=" command)="" option.allowreuse="true;" continue;="" else="" ("if"="=" conditional="/^\*if\s+\((.+)\)\s+([^\)]+)/.exec(line);" (!conditional)="" invalid="" *if,="" ()="" followed="" by="" scene="" name:="" line);="" stack="this.tokenizeExpr(conditional[1]);" this.evaluateexpr(stack);="" option.conditional="conditional[1];" command:="" todo="" weights="" option.name="trim(line);" options.push(option);="" return="" options;="" };="" scene.prototype.computerandomselection="function" computerandomselection(randomfloat,="" options,="" allowreuseglobally)="" filtered="[];" finished="{};" (!allowreuseglobally)="" (!this.stats.choice_grs)="" this.stats.choice_grs="[];" grs="this.stats.choice_grs;" for="" (var="" i="0;" grs.length;="" i++)="" finished[grs[i]]="1;" option;="" (i="0;" options.length;="" (!option.allowreuse)="" (finished[option.name])="" (option.conditional)="" pass="this.evaluateExpr(stack);" (!pass)="" filtered.push(option);="" (!filtered.length)="" null;="" randomselection="Math.floor(randomFloat*filtered.length);" this.stats.choice_grs.push(option.name);="" scene.prototype.end_trial="function" endtrial()="" this.paragraph();="" printlink(this.target,="" "#",="" "start="" over="" from="" beginning",="" function(e)="" preventdefault(e);="" restartgame("prompt");="" });="" this.prevline="block" ;="" this.screenempty="false;" this.finished="true;" scene.prototype.achieve="function" scene_achieve(name)="" name="name.toLowerCase();" (!this.nav.achievements.hasownproperty(name))="" "the="" achievement="" "+name+"="" not="" declared="" as="" an="" *achievement="" startup");="" this.nav.achieved[name]="true;" (typeof="" window="" &&="" typeof="" achieve="" )="" achieve(name,="" achievement.title,="" achievement.earneddescription);="" scene.prototype.check_achievements="function" scene_checkachievements()="" self="this;" function="" callback(immediately)="" nav.achievements)="" self.temps["choice_achieved_"+achievement]="nav.achieved.hasOwnProperty(achievement);" (!immediately)="" self.finished="false;" self.skipfooter="false;" self.execute();="" checkachievements="=" "undefined")="" callback("immediately");="" this.skipfooter="true;" checkachievements(callback);="" scene.prototype.scene_list="function" scene_list()="" scenes="this.parseSceneList();" this.nav.setscenelist(scenes);="" scene.prototype.parsescenelist="function" parsescenelist()="" nextindent="null;" line;="" startindent="this.indent;" while(isdefined(line="this.lines[++this.lineNum]))" (!trim(line))="" indent="this.getIndent(line);" (nextindent="==" null="" ||="" undefined)="" initialize="" with="" whatever="" turns="" out="" ...unless="" indented="" row");="" scenes;="" purchasematch="/^\$(\w*)\s+(.*)/.exec(line);" (purchasematch)="" (!scenes.length="" "startup"="" scenes.push("startup");="" scenes.push(line);="" scene.prototype.title="function" scene_title(title)="" changetitle="" changetitle(title);="" scene.prototype.author="function" scene_author(author)="" changeauthor="" changeauthor(author);="" hidden|visible="" earned="" description="" pre-earned="" scene.prototype.achievement="function" scene_achievement(data)="" parsed="/(\S+)\s+(\S+)\s+(\S+)\s+(.*)/.exec(data);" (!parsed)="" *achievement,="" requires="" short="" name,="" visibility,="" points,="" and="" display="" title:="" data);="" achievementname="parsed[1];" (!="" ^[a-z][a-z0-9_]+$="" .test(achievementname))="" error(this.linemsg()+"invalid="" +achievementname);="" (this.nav.achievements.hasownproperty(achievementname))="" this="" already="" exists...="" preexisting="this.nav.achievements[achievementName];" (!preexisting.linenumber="" preexisting.linenumber="=" (this.linenum+1))="" restarting="" randomtest="" will="" naturally="" re-run="" *achievements;="" ignore="" those="" blow="" away="" pre-existing="" mygame.js="" achievements="" this.nav.achievements="{};" this.nav.achievementlist="[];" this.achievementtotal="0;" this.seenachievementtitles="{};" don't="" allow="" redefining="" error(this.linemsg()+"achievement="" "+achievementname+"="" defined="" on="" this.nav.achievements[achievementname].linenumber);="" linenumber="this.lineNum+1;" visibility="parsed[2];" (visibility="" second="" word="" should="" either="" 'hidden'="" 'visible':="" +visibility);="" visible="(visibility" );="" pointstring="parsed[3];" [1-9][0-9]*="" .test(pointstring))="" third="" integer="" number="" of="" points:="" pointstring);="" points="parseInt(pointString," 10);="" (points=""> 100) throw new Error(this.lineMsg()+"Invalid *achievement, no achievement may be worth more than 100 points: " + points);
...
Scene.operators = {
    ...
    "%+": function fairAdd(v1, v2, line) {
        v1 = num(v1,line);
        v2 = num(v2,line);
        var validValue = (v1 >= 0 && v1 <= 100);="" if="" (!validvalue)="" {="" throw="" new="" error("line="" "+line+":="" can't="" fairadd="" to="" non-percentile="" value:="" "="" +="" v1);="" }="" (v2=""> 0) {
    ...
    "<": function="" lessthan(v1,v2,line)="" {="" return="" num(v1,line)="" <="" num(v2,line);="" },="" "="">": function greaterThan(v1,v2,line) { return num(v1,line) > num(v2,line); },
    "<=": function="" lessthanorequals(v1,v2,line)="" {="" return="" num(v1,line)="" <="num(v2,line);" },="" "="">=": function greaterThanOrEquals(v1,v2,line) { return num(v1,line) >= num(v2,line); },
